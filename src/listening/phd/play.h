...
extern bool_t phd_handle_query_block_nbt(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_set_difficulty(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_chat_message(ltg_client_t*, pck_packet_t*);
...
extern bool_t phd_handle_tab_complete(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_click_window_button(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_click_window(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_close_window(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_plugin_message(ltg_client_t*, pck_packet_t*, int32_t);
extern bool_t phd_handle_edit_book(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_query_entity_nbt(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_interact_entity(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_generate_structure(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_keep_alive(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_lock_difficulty(ltg_client_t*, pck_packet_t*);
...
extern bool_t phd_handle_player_rotation(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_player_movement(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_vehicle_move(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_steer_boat(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_pick_item(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_craft_recipe_request(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_player_abilities(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_player_digging(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_entity_action(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_steer_vehicle(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_pong(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_set_recipe_book_state(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_set_displayed_recipe(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_name_item(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_resource_pack_status(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_advancement_tab(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_select_trade(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_set_beacon_effect(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_held_item_change(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_update_command_block(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_update_command_block_minecart(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_creative_inventory_action(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_update_jigsaw_block(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_update_structure_block(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_update_sign(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_animation(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_spectate(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_player_block_placement(ltg_client_t*, pck_packet_t*);
extern bool_t phd_handle_use_item(ltg_client_t*, pck_packet_t*);
