...
const mat_tag_t mat_block_tag_mineable_d = {
	.identifier = UTL_CSTRTOSTR("motor:mineable"),
	.count = 661,
	.entries = {
		mat_block_note_block,
		mat_block_attached_melon_stem,
...
const mat_tag_t mat_block_tag_needs_d = {
	.identifier = UTL_CSTRTOSTR("motor:needs"),
	.count = 294,
	.entries = {
		mat_block_obsidian,
		mat_block_crying_obsidian,
...
const mat_tag_t mat_block_tag_needs_wooden_tool_d = {
	.identifier = UTL_CSTRTOSTR("motor:needs_wooden_tool"),
	.count = 234,
	.entries = {
		mat_block_ender_chest,
		mat_block_anvil,
