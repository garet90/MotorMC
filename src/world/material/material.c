...
const mat_block_t mat_block_block_of_coal_d = {
    .resistance = 6,
    .hardness = 5,
    .encouragement = 5,
    .flammability = 5
};
const mat_block_t mat_block_block_of_copper_d = {
    .resistance = 6,
    .hardness = 3
};
const mat_block_t mat_block_block_of_diamond_d = {
    .resistance = 6,
    .hardness = 5
};
...
const mat_block_t mat_block_block_of_gold_d = {
    .resistance = 6,
    .hardness = 3
};
const mat_block_t mat_block_block_of_iron_d = {
    .resistance = 6,
    .hardness = 5
};
const mat_block_t mat_block_block_of_lapis_lazuli_d = { 
    .resistance = 3,
    .hardness = 3
};
const mat_block_t mat_block_block_of_netherite_d = {
    .resistance = 1200,
    .hardness = 50
};
const mat_block_t mat_block_block_of_quartz_d = { 
    .resistance = 0.8,
    .hardness = 0.8
};
const mat_block_t mat_block_block_of_raw_copper_d = { 
    .resistance = 6,
    .hardness = 3
};
const mat_block_t mat_block_block_of_raw_gold_d = { 
    .resistance = 6,
    .hardness = 3
};
const mat_block_t mat_block_block_of_raw_iron_d = { 
    .resistance = 6,
    .hardness = 5
};
const mat_block_t mat_block_block_of_redstone_d = {
    .resistance = 6,
    .hardness = 5
};
...
const mat_block_t mat_block_deepslate_lapis_lazuli_ore_d = { 
    .resistance = 3,
    .hardness = 4.5
};
...
const mat_block_t mat_block_redstone_comparator_d = { 
    .resistance = 0,
    .hardness = 0,
    .tags = {
        utl_arraybit(mat_block_tag_transparent)
...
const mat_block_t mat_block_redstone_repeater_d = { 
    .resistance = 0,
    .hardness = 0,
    .tags = {
        utl_arraybit(mat_block_tag_transparent)
...
const mat_block_t mat_block_smooth_quartz_block_d = { 
    .resistance = 6,
    .hardness = 2
};
...
const mat_block_t mat_block_glow_berries_d = {
    .resistance = 0,
    .hardness = 0,
    .luminance = 14
};
...
const mat_block_t* mat_blocks[] = {
	...
	&mat_block_block_of_amethyst_d,
	&mat_block_block_of_coal_d,
	&mat_block_block_of_copper_d,
	&mat_block_block_of_diamond_d,
	&mat_block_block_of_emerald_d,
	&mat_block_block_of_gold_d,
	&mat_block_block_of_iron_d,
	&mat_block_block_of_lapis_lazuli_d,
	&mat_block_block_of_netherite_d,
	&mat_block_block_of_quartz_d,
	&mat_block_block_of_raw_copper_d,
	&mat_block_block_of_raw_gold_d,
	&mat_block_block_of_raw_iron_d,
	&mat_block_block_of_redstone_d,
	...
	&mat_block_deepslate_lapis_lazuli_ore_d,
	...
	&mat_block_redstone_comparator_d,
	&mat_block_redstone_lamp_d,
	&mat_block_redstone_ore_d,
	&mat_block_redstone_repeater_d,
	...
	&mat_block_smooth_quartz_block_d,
	...
	&mat_block_water_d,
	&mat_block_waxed_block_of_copper_d,
